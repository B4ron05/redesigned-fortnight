...
def evaluate_bias(asset, metric_name, difference, current_value=None, ffr_val=None, cpi_val=None):
    ...
    elif metric_name in ["GDP Growth QoQ", "Retail Sales MoM", "Personal Income MoM", "Personal Spending MoM", "Michigan Consumer Sentiment", "Manufacturing PMI", "Services PMI"]:
        if difference > 0:
    ...
    # --- 1.b. INVERSE CONSUMER BLOCK (Savings) ---
        ...
        # Rising savings = cash hoarding / less spending -> Bearish for Growth Assets
        if difference > 0:
            if asset in usd: return "Bearish", BEARISH
