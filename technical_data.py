...
# 1. 4H / Daily Trend (50 SMA)
    try:
        ...
        if not hist.empty:
            ...
            # --- THE FIX: Scrub out any 'NaN' placeholder rows from yfinance ---
            hist = hist.dropna(subset=['Close'])
            
            # Make sure we actually have 50 days of data to calculate a 50 SMA!
            if len(hist) >= 50:
